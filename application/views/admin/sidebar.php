<div class="admin-sidebar">
  <a href="<?= base_url('admin_panel')?>" class="admin-page-active"><i class="fas fa-home"></i> Home</a>
  <a href="<?= base_url('fetch_question/maths')?>" class=""><i class="fas fa-list-ul"></i></i> Questions</a>
  <a href="<?= base_url('result/imat')?>" class=""><i class="fas fa-certificate"></i></i> Result</a> <!--
  <a href="<?= base_url('newTrip')?>" class=""><i class="fas fa-plus-circle"></i> Add #</a>
