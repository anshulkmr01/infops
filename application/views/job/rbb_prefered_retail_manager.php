                	    	...
                	    	<div class="course-instructor">
                	    		<div class="row">
                	    			<div class="col-md-6 mobile-mb-20">
                	    				...
                	    				<p>	<b>Job Title </b>RBB-PREFERRED RELATIONSHIP MANAGER  </p>
                                      <p><b>DEPARTMENT</b> Retail Branch Banking</p>
                	    				</div>
                	    			</div>
                	    			<div class="col-md-6">
                                ...
                                <div id="accordion" class="rs-accordion-style1">
                                    <div class="card">
                                        ...
                                        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                                            <div class="card-body">
                                              <ul>
                                              <li>•	Managing the High Net Worth customers of the Bank</li>
                                              <li>•	Achieving the Business targets assigned in tem of cross selling enhancing and upgrading the High Net Worth Relationships.</li>
                                              <li>•	Profiling Customers and provide financial products to meet customer needs</li>
                                              <li>•	Ensuring the highest levels of service to the High Net  Worth customers </li>
                                              <li>•	Providing Financial planning & Investment Advise </li>
                                              <li>•	Sales targets spread across Liabilities, Retail Assets, Business Banking, Forex, Credit Cards, Online Trading etc.</li>
                                              <li>•	One point contact for all requirements of High Net Worth customers in the Branch</li>
                                              <li>•	Acquisition & Servicing of High Net Worth customers </li>
                                              </ul>
                                    ...
                                    <div class="card">
                                        ...
                                        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
                                            <div class="card-body">
                                                ...
                                                <li>•	Interpersonal & Influential Skills</li>
                                                <li>•	Should have good knowledge of liability product </li>
                                                <li>•	Should have knowledge of Third Party Products like Insurance and Mutual Fund</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
