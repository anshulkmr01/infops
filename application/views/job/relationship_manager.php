                	    	...
                	    	<div class="course-instructor">
                	    		<div class="row">
                	    			<div class="col-md-6 mobile-mb-20">
                	    				...
                	    				<p>	<b>Job Title </b>RM-RA  </p>
                                      <p><b>DEPARTMENT</b>Transportation Group </p>
                	    				</div>
                	    			</div>
                	    			<div class="col-md-6">
                                ...
                                <div id="accordion" class="rs-accordion-style1">
                                    <div class="card">
                                        ...
                                        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                                            <div class="card-body">
                                             <p>Summarise briefly, why your job exists </p>
                                    ...
                                    <div class="card">
                                        <div class="card-header" id="headingTwo">
                                            ...
                                            <strong>PRINCIPLE ACCOUNTABILITIES  </strong>
                                            </h3>
                                        </div>
                                        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
                                            <div class="card-body">
                                                ...
                                                <li>•	Achieve Business targeted number</li>
                                                <li>•	Monitor portfolio quality </li>
                                                <li>•	PDD/Deferral management </li>
                                                <li>•	Engage with dealer, Top customers and Manufactures</li>
                                                <li>•	Drive Bank key Initiatives on digital platform </li>
                                                <li>•	Liaise with branch Banking to increase Internal Business sourcing  </li>
                                                <li>•	Cross-Sell of various Assets and Liability products</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card">
                                        ...
                                        <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordion">
                                            <div class="card-body">
                                               ...
                                               <ul>
                                               <li>•	State the minimum acceptable proficiency for this job Do not state incumbent – specific information </li>
                                             <li>•	Education Background – Graduate, Post Graduate</li>
                                                <li>•	Total Work experience –  0 – 1 Years </li>
