                	    	...
                	    	<div class="course-instructor">
                	    		<div class="row">
                	    			<div class="col-md-6 mobile-mb-20">
                	    				<h3 class="instructor-title"> <Label>SALES MANAGER</Label></h3>
                                ...
                                <div id="accordion" class="rs-accordion-style1">
                                    <div class="card">
                                        ...
                                        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                                            <div class="card-body">
                                              <ul>
                                              <li>•	Handle a team of Tele sales Executives (TSE’s) Field Sales Executives (FSE’s)</li>
                                              <li>•	Must ensure Fincon target are met across all various product viz TEAM (INSTA JUMBO & EMI RTO LE & FOREX TPP and Other Bank Assets).</li>
                                              <li>•	TSE to Achieve/met their daily productivity benchmarks which needs to be monitored </li>
                                              <li>•	Ensure all TSEs are educated on PLP earning.</li>
                                              <li>•	Help TSEs to achieve set target & meet their required productivity.</li>
                                              <li>•	Product mix has to be chosen in such a way to have reduced cost of acquisition & make the channel profitable. </li>
                                    ...
                                    <div class="card">
                                        ...
                                        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
                                            <div class="card-body">
                                                ...
                                                <li>•	Good product and process knowledge.</li>
                                                <li> •	Good product and process knowledge.</li>
                                                <li>•	Team Managements Skills. </li>
