                	    	...
                	    	<div class="course-instructor">
                	    		<div class="row">
                	    			<div class="col-md-6 mobile-mb-20">
                	    				<h3 class="instructor-title"><Label>ASSISTANT AUDITOR</Label></h3>
                	    				...
                	    				<p>	<b>Job Title </b>Assistant  Auditor Retail Assets </p>
                                      <p><b>Department</b> Audit</p>
                	    				</div>
                	    			</div>
                	    			<div class="col-md-6">
                                ...
                                <div id="accordion" class="rs-accordion-style1">
                                    <div class="card">
                                        ...
                                        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                                            <div class="card-body">
                                              <ul>
                                              <li>•	To undertake audit of various task assigned as per the audit calendar within the large time.</li>
                                              <li>•	Timely accurate concern and effective documents of audit reports on exceptions observation during the count. </li>
                                              <li>•	Ensure qualitative and effective performance in all area undertaken,</li>
                                              <li>•	Critically review the existing process and procedures during the audit of respective areas and suggest areas of improvement which would enhance control and simplify process flow.</li>
                                              <li>•	Identify any operations risk areas and escalate to the team leaders.</li>
                                              <li>•	Review and follow up of rectification responses from the audit for early rectification of audit comments and time of audit files.    </li>
                                              <li>•	To effectively track and identify revenue leakage and suggest measures process to plug the same.</li>
                                              <li>•	Job involves carrying cut various Audit reviews.</li>
                                              </ul>
