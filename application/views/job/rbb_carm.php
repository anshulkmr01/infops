                	    	...
                	    	<div class="course-instructor">
                	    		<div class="row">
                	    			<div class="col-md-6 mobile-mb-20">
                	    				<h3 class="instructor-title"><Label>CREDIT  UNDERWRITER-Authentication</Label></h3>
...
<!--                 	    				<%--	<div class="instructor-body">
                	    				...
                	    				<p>	<b>Job Title </b>RIGHT BUNDLE BRANCH CONTROL ASSESSMENT RISK MANAGEMENT 
RBB
</p>
                                ...
                                <div id="accordion" class="rs-accordion-style1">
                                    <div class="card">
                                        ...
                                        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                                            <div class="card-body">
                                              <ul>
                                              <li>•	Customer engagement/personal visit at pre-defined frequency </li>
                                              <li>•	Specialized resource to pro-actively resolve customer queries; service requirement product customization etc to ensure primary banking behaviour.</li>
                                              <li>•	Help customer with appropriate product to full family and business banking needs including those of group Firms and thereby maximize relationship value </li>
                                              <li>•	Understand customer business profile/requirement and fulfil needs via product/service such as Trade Finance/Forex, Cash Management Service POS Machines/ Payment Getway solution doorstep banking Loans, Life/ General Insurance etc</li>
                                              <li>•	Migration of transactions to Digital Banking Channel i e Net Banking/E-Net, Mobile Banking, Phone Banking Insta-Alerts Email Statements etc as per customer profile/need/ Preference </li>
                                              <li>•	Maintaining portfolio health i.e Account Activation & balance Maintenance      </li>
                                              <li>•	Ensure action on central triggers/ customer service initiatives </li>
                                              </ul>
